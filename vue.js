...
new Vue({
    el: '#navbar',
    data: {
        nav: '<nav class="navbar site-header sticky-top py-1 mt-4"><div class="container d-flex flex-column flex-md-row justify-content-around"><div id="component1"><mycomponent1> </mycomponent1></div><a class="py-2 d-none d-md-inline-block text-uppercase" href="#">Home</a><a class="py-2 d-none d-md-inline-block text-uppercase" href="#">Recipes </a><a class="py-2 d-none d-md-inline-block text-uppercase" href="#">Lifestyles </a><a class="py-2 d-none d-md-inline-block text-uppercase" href="#">Videos </a><a class="py-2 d-none d-md-inline-block mr-5 text-uppercase" href="#">About </a></div></nav>'
    }
});
